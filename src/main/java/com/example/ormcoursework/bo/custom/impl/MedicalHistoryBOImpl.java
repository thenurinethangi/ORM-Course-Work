...
public class MedicalHistoryBOImpl implements MedicalHistoryBO {
    ...
    public PatientDTO getPatientDetailsById(String id) {
        ...
        return EntityToDTO.ToPatientDTO(patientDAO.search(id));
    }

    @Override
    public boolean add(MedicalHistoryDTO medicalHistoryDTO) {

        return medicalHistoryDAO.add(DTOToEntity.ToMedicalHistoryEntity(medicalHistoryDTO));
    }

    @Override
    public boolean delete(MedicalHistoryDTO medicalHistoryDTO) {

        return medicalHistoryDAO.delete(DTOToEntity.ToMedicalHistoryEntity(medicalHistoryDTO));
    }

    @Override
    public boolean update(MedicalHistoryDTO medicalHistoryDTO) {

        return medicalHistoryDAO.update(DTOToEntity.ToMedicalHistoryEntity(medicalHistoryDTO));
    }
}
