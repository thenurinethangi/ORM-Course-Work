...
public class DashboardBOImpl implements DashboardBO {
    ...
    public List<Integer> getThisMonthSessions() {
        ...
        List<TherapySession> therapySessionList = sessionDAO.getThisMonthSessionsList();
        ...
        for (int i = 0; i < days.size(); i++) {
            for (int j = 0; j < therapySessionList.size(); j++) {
                String y = therapySessionList.get(j).getDate();
                String[] arr = y.split(" ");
