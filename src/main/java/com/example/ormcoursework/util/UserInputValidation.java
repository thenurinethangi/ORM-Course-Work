...
public class UserInputValidation {
    ...
    private static final String bloodPressure = "^(9[0-9]|1[0-9]{2}|2[0-4][0-9]|250)/(6[0-9]|7[0-9]|8[0-9]|9[0-9]|100)$";
    ...
    public  static boolean checkBloodPressureValidation(String blood){

        return Pattern.matches(bloodPressure,blood);
    }
