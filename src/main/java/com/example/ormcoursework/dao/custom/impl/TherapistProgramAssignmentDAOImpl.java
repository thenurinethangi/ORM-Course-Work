...
public class TherapistProgramAssignmentDAOImpl implements TherapistProgramAssignmentDAO {
    ...
    @Override
    public boolean delete(TherapistProgramAssignment therapistProgramAssignment) {
        return false;
    }
    ...
    @Override
    public boolean update(TherapistProgramAssignment therapistProgramAssignment) {
        return false;
    }

    @Override
    public TherapistProgramAssignment search(String id) {
        return null;
    }
